...
export class Card extends HTMLElement {
    ...
    */
    static #getNavigableElements({ container, scope = false }) {
        scope = (scope) ? "" : ":scope > ";
        const navigable = container.querySelectorAll(`${scope}button:not([disabled]), ${scope}textarea:not([disabled]), ${scope}input:not([disabled]), ${scope}select:not([disabled]), ${scope}a[href]:not([disabled]), ${scope}[tabindex]:not([tabindex="-1"])`);
